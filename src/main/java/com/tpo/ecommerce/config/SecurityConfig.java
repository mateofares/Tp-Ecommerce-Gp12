    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers(HttpMethod.GET, "/resenias/vendedor/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/productos/**").hasAnyAuthority("USUARIO", "ADMINISTRADOR")
                        .requestMatchers(HttpMethod.DELETE, "/productos/**").hasAnyAuthority("USUARIO", "ADMINISTRADOR")
